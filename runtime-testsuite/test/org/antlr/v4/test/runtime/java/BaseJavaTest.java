...
public class BaseJavaTest extends BaseRuntimeTestSupport {
	@Override
	...
	protected JavaCompiledState compile(RunOptions runOptions, GeneratedState generatedState) {
		...
		try {
			...
			File tempTestDir = getTempTestDir();
			...
			loader = new URLClassLoader(new URL[]{tempTestDir.toURI().toURL()}, systemClassLoader);
