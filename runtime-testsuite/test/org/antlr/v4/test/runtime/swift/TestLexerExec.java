...
public class TestLexerExec extends BaseTest {
	...
	public void testActionPlacement() throws Exception {
		...
		grammarBuilder.append("I : ({print(\"stuff fail: \" + self.getText())} 'a'\n");
		grammarBuilder.append("| {print(\"stuff0: \" + self.getText())}\n");
		grammarBuilder.append("		'a' {print(\"stuff1: \" + self.getText())}\n");
		grammarBuilder.append("		'b' {print(\"stuff2: \" + self.getText())})\n");
		grammarBuilder.append("		{print(self.getText())} ;\n");
	...
	public void testGreedyConfigs() throws Exception {
		...
		grammarBuilder.append("lexer grammar L;\n");
		grammarBuilder.append("I : ('a' | 'ab') {print(self.getText())} ;\n");
		grammarBuilder.append("WS : (' '|'\\n') -> skip ;\n");
		grammarBuilder.append("J : .;");
		String grammar = grammarBuilder.toString();
	...
	public void testNonGreedyConfigs() throws Exception {
		...
		grammarBuilder.append("I : .*? ('a' | 'ab') {print(self.getText())} ;\n");
		grammarBuilder.append("WS : (' '|'\\n') -> skip ;\n");
		grammarBuilder.append("J : . {print(self.getText())};");
		String grammar = grammarBuilder.toString();
	...
	public void testPositionAdjustingLexer() throws Exception {
		...
		grammarBuilder.append("	}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("	return try super.nextToken()\n");
		grammarBuilder.append("}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("override\n");
		...
		grammarBuilder.append("\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("//public func getInterpreter() -> PositionAdjustingLexerATNSimulator {\n");
		...
		grammarBuilder.append("}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("class PositionAdjustingLexerATNSimulator: LexerATNSimulator {\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("	  init(_ recog: Lexer,_ atn: ATN,\n");
		grammarBuilder.append("				 _ decisionToDFA: [DFA],\n");
		grammarBuilder.append("				 _ sharedContextCache:PredictionContextCache)\n");
		grammarBuilder.append("	{\n");
		...
		grammarBuilder.append("		try! consume(input)\n");
		grammarBuilder.append("	}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("}\n");
		grammarBuilder.append("\n");
