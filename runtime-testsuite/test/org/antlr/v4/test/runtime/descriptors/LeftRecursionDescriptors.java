...
public class LeftRecursionDescriptors {
    ...
    /*
     * This is a regression test for antlr/antlr4#433 (modified for D) "Not all context accessor
     * methods are generated when an alternative rule label is used for multiple
     * alternatives".
     * https://github.com/antlr/antlr4/issues/433
     */
    public static abstract class MultipleAlternativesWithCommonLabel_d extends BaseParserTestDescriptor {
        public String startRule = "s";
        public String grammarName = "T";
        public String errors = null;
        ...
        /**
         ...
         e returns [int v]
           ...
           | INT         {$v = $INT.int;}                   # anInt
           | '(' e ')'   {$v = $e.v;}                       # parens
           | left=e INC  {<Cast("UnaryContext","$ctx"):Concat(".INC() !is null"):Assert()>$v = $left.v + 1;}      # unary
           | left=e DEC  {<Cast("UnaryContext","$ctx"):Concat(".DEC() !is null"):Assert()>$v = $left.v - 1;}      # unary
           | ID          {<AssignLocal("$v","3")>}                                                     # anID
           ;
         ID : 'a'..'z'+ ;
         INT : '0'..'9'+ ;
    ...
    public static class MultipleAlternativesWithCommonLabel_1_d extends MultipleAlternativesWithCommonLabel_d {
        public String input = "4";
        public String output = "4\n";
    ...
    public static class MultipleAlternativesWithCommonLabel_2_d extends MultipleAlternativesWithCommonLabel_d {
        public String input = "1+2";
        public String output = "3\n";
    ...
    public static class MultipleAlternativesWithCommonLabel_3_d extends MultipleAlternativesWithCommonLabel_d {
        public String input = "1+2*3";
        public String output = "7\n";
    ...
    public static class MultipleAlternativesWithCommonLabel_4_d extends MultipleAlternativesWithCommonLabel_d {
        public String input = "i++*3";
        public String output = "12\n";
    ...
    /** Test for https://github.com/antlr/antlr4/issues/1295 in addition to #433. */
    public static class MultipleAlternativesWithCommonLabel_5_d extends MultipleAlternativesWithCommonLabel_d {
        public String input = "(99)+3";
        public String output = "102\n";
    ...
    public static abstract class PrefixOpWithActionAndLabel_d extends BaseParserTestDescriptor {
        public String errors = null;
        public String startRule = "s";
        public String grammarName = "T";
    ...
    public static class PrefixOpWithActionAndLabel_1_d extends PrefixOpWithActionAndLabel_d {
        public String input = "a";
    ...
    public static class PrefixOpWithActionAndLabel_2_d extends PrefixOpWithActionAndLabel_d {
        public String input = "a+b";
    ...
    public static class PrefixOpWithActionAndLabel_3_d extends PrefixOpWithActionAndLabel_d {
        public String input = "a=b+c";
