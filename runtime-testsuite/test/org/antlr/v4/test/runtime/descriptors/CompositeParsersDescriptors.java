...
public class CompositeParsersDescriptors {
    ...
    public static class DelegatorRuleOverridesLookaheadInDelegate_d extends BaseCompositeParserTestDescriptor {
        public String input = "float x = 3;";
        public String output = "JavaDecl: floatx=3;\n";
        public String errors = null;
        public String startRule = "prog";
        ...
        type_ : 'int' ;
        decl : type_ ID ';'
            | type_ ID init_ ';' {<write("\"JavaDecl: \" ~ $text.get!string")>};
        init_ : '=' INT;
         */
        @CommentHasStringValue
        public String slaveGrammarS;
