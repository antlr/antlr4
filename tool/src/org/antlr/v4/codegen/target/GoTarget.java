...
public class GoTarget extends Target {
	protected static final HashSet<String> reservedWords = new HashSet<>(Arrays.asList(
		...
		// interface definition of RuleContext from runtime/Go/antlr/v4/rule_context.go
		"Accept", "GetAltNumber", "GetChild", "GetChildCount",
		...
		"SetInvokingState", "SetParent", "String", "ToStringTree",
		...
		"start", "Start", "stop", "Stop", "exception", "Exception",
		"altNumber", "AltNumber", "child", "Child", "childCount", "ChildCount",
		"children", "Children", "invokingState", "InvokingState",
		"parent", "Parent", "payload", "Payload",
		"ruleContext", "RuleContext", "ruleIndex", "RuleIndex",
		"sourceInterval", "SourceInterval", "text", "Text",
		"token", "Token", "tokens", "Tokens",
		"childOfType", "ChildOfType",
		"typedRuleContext", "TypedRuleContext",
		"typedRuleContexts", "TypedRuleContexts",
