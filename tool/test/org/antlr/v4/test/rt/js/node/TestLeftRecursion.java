...
public class TestLeftRecursion extends BaseTest {
	...
	String testTernaryExpr(String input) throws Exception {
		String grammar = "grammar T;\n" +
	                  "s @after {console.log($ctx.toStringTree(null, this));} : e EOF ; // must indicate EOF can follow or 'a<EOF>' won't match\n" +
	                  "e : e '*' e\n" +
	                  "  | e '+' e\n" +
	                  "  |<assoc=right> e '?' e ':' e\n" +
	                  "  |<assoc=right> e '=' e\n" +
	...
	String testExpressions(String input) throws Exception {
		String grammar = "grammar T;\n" +
	                  "s @after {console.log($ctx.toStringTree(null, this));} : e EOF ; // must indicate EOF can follow\n" +
	                  "e : e '.' ID\n" +
	                  "  | e '.' 'this'\n" +
	                  "  | '-' e\n" +
	                  "  | e '*' e\n" +
	...
	String testDeclarations(String input) throws Exception {
		String grammar = "grammar T;\n" +
	                  "s @after {console.log($ctx.toStringTree(null, this));} : declarator EOF ; // must indicate EOF can follow\n" +
	                  "declarator\n" +
	                  "        : declarator '[' e ']'\n" +
	                  "        | declarator '[' ']'\n" +
	                  "        | declarator '(' ')'\n" +
	...
	String testReturnValueAndActionsList1(String input) throws Exception {
		String grammar = "grammar T;\n" +
	                  "s @after {console.log($ctx.toStringTree(null, this));} : expr EOF;\n" +
	                  "expr:\n" +
