...
public class TestParserExec extends BaseTest {
	...
	public void testIfIfElseGreedyBinding1() throws Exception {
		String grammar = "grammar T;\n" +
	                  ...
	                  "ID : 'a'..'z'+ ;\n" +
	                  "WS : (' '|'\\n') -> channel(HIDDEN);";
		String found = execParser("T.g4", grammar, "TParser", "TLexer", "TListener", "TVisitor", "start", "if y if y x else x");
	...
	public void testPredicatedIfIfElse() throws Exception {
		String grammar = "grammar T;\n" +
	                  ...
	                  "ID : [a-zA-Z]+;\n" +
	                  "WS : [ \\n\\t]+ -> skip;";
		String found = execParser("T.g4", grammar, "TParser", "TLexer", "TListener", "TVisitor", "s", "if x if x a else b");
		assertEquals("", found);
		assertNull(this.stderrDuringParse);
	}
	...
	public void testLabelAliasingAcrossLabeledAlternatives() throws Exception {
		String grammar = "grammar T;\n" +
	                  ...
	                  "subrule : 'x';\n" +
	                  "WS : (' '|'\\n') -> skip ;";
		String found = execParser("T.g4", grammar, "TParser", "TLexer", "TListener", "TVisitor", "start", "xy");
		assertEquals("x\ny\n", found);
		assertNull(this.stderrDuringParse);
	}
	...
	public void testPredictionIssue334() throws Exception {
		String grammar = "grammar T;\n" +
	                  ...
	                  "B : 'b'|'B';\n" +
	                  "WS      : [ \\r\\t\\n]+ -> skip;";
		String found = execParser("T.g4", grammar, "TParser", "TLexer", "TListener", "TVisitor", "file_", "a");
	...
	public void testListLabelForClosureContext() throws Exception {
		String grammar = "grammar T;\n" +
	                  ...
	                  "elseStatement : 'a' ;";
		String found = execParser("T.g4", grammar, "TParser", "TLexer", "TListener", "TVisitor", "expression", "a");
		assertEquals("", found);
		assertNull(this.stderrDuringParse);
	}
	...
	public void testMultipleEOFHandling() throws Exception {
		String grammar = "grammar T;\n" +
	                  "prog : ('x' | 'x' 'y') EOF EOF;";
		String found = execParser("T.g4", grammar, "TParser", "TLexer", "TListener", "TVisitor", "prog", "x");
		assertEquals("", found);
		assertNull(this.stderrDuringParse);
	}
	...
	public void testAlternateQuotes() throws Exception {
		...
		mkdir(tmpdir);
		writeFile(tmpdir, "ModeTagsLexer.g4", slave_ModeTagsLexer);
		...
		String grammar = "parser grammar ModeTagsParser;\n" +
	                  ...
	                  "    | '«' '/' ID '»'\n" +
	                  "    ;";
		String found = execParser("ModeTagsParser.g4", grammar, "ModeTagsParserParser", "ModeTagsParserLexer", "ModeTagsParserListener", "ModeTagsParserVisitor", "file_", "");
		assertEquals("", found);
		assertNull(this.stderrDuringParse);
	}
