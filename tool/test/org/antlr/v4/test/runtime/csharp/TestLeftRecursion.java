...
public class TestLeftRecursion extends BaseTest {
	...
	public void testTernaryExprExplicitAssociativity_5() throws Exception {
		...
		grammarBuilder.append("s @after {Console.WriteLine($ctx.ToStringTree(this));} : e EOF; // must indicate EOF can follow or 'a<EOF>' won't match\n");
	...
	public void testReturnValueAndActionsAndLabels_2() throws Exception {
		mkdir(tmpdir);
		StringBuilder grammarBuilder = new StringBuilder(460);
		grammarBuilder.append("grammar T;\n");
	...
	public void testJavaExpressions_9() throws Exception {
		mkdir(tmpdir);
		StringBuilder grammarBuilder = new StringBuilder(1254);
		grammarBuilder.append("grammar T;\n");
	...
	public void testDeclarations_10() throws Exception {
		mkdir(tmpdir);
		StringBuilder grammarBuilder = new StringBuilder(398);
		grammarBuilder.append("grammar T;\n");
