...
public class TestListeners extends BaseTest {
	...
	public void testTokenGetters_1() throws Exception {
		mkdir(tmpdir);
		StringBuilder grammarBuilder = new StringBuilder(929);
		...
		grammarBuilder.append("        }\n");
		grammarBuilder.append("    	document.getElementById('output').value += str + '\\n';\n");
		grammarBuilder.append("    };\n");
		...
		grammarBuilder.append("document.getElementById('output').value += $ctx.r.toStringTree(null, this) + '\\n';\n");
	...
	public void testBasic() throws Exception {
		...
		grammarBuilder.append("    	document.getElementById('output').value += node.symbol.text + '\\n';\n");
		grammarBuilder.append("    };\n");
		grammarBuilder.append("    return this;\n");
		grammarBuilder.append("};\n");
		grammarBuilder.append("this.LeafListener.prototype = Object.create(TListener.prototype);\n");
	...
	public void testLRWithLabels() throws Exception {
		mkdir(tmpdir);
		StringBuilder grammarBuilder = new StringBuilder(941);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("@parser::header {\n");
		grammarBuilder.append("var TListener = require('./TListener').TListener;\n");
		grammarBuilder.append("}\n");
	...
	public void testRuleGetters_1() throws Exception {
		mkdir(tmpdir);
		StringBuilder grammarBuilder = new StringBuilder(942);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("@parser::header {\n");
		grammarBuilder.append("var TListener = require('./TListener').TListener;\n");
		grammarBuilder.append("}\n");
	...
	public void testLR() throws Exception {
		mkdir(tmpdir);
		StringBuilder grammarBuilder = new StringBuilder(917);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("@parser::header {\n");
		grammarBuilder.append("var TListener = require('./TListener').TListener;\n");
		grammarBuilder.append("}\n");
