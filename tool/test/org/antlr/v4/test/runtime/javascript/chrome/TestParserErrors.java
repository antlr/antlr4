...
public class TestParserErrors extends BaseTest {
	...
	public void testConjuringUpTokenFromSet() throws Exception {
		...
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("a : 'a' x=('b'|'c') {document.getElementById('output').value += \"conjured=\" + $x + '\\n';} 'd' ;");
		String grammar = grammarBuilder.toString();
		String input ="ad";
		String found = execParser("T.g4", grammar, "TParser", "TLexer",
		                          "TListener", "TVisitor",
	...
	public void testConjuringUpToken() throws Exception {
		...
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("a : 'a' x='b' {document.getElementById('output').value += \"conjured=\" + $x + '\\n';} 'c' ;");
		String grammar = grammarBuilder.toString();
		String input ="ac";
		String found = execParser("T.g4", grammar, "TParser", "TLexer",
		                          "TListener", "TVisitor",
	...
	public void testSingleTokenDeletionConsumption() throws Exception {
		...
		grammarBuilder.append("a: 'a' myset 'd' {document.getElementById('output').value += \"\" + $myset.stop + '\\n';} ; ");
		String grammar = grammarBuilder.toString();
		String input ="aabd";
		String found = execParser("T.g4", grammar, "TParser", "TLexer",
		                          "TListener", "TVisitor",
	...
	public void testLL1ErrorInfo() throws Exception {
		mkdir(tmpdir);
		StringBuilder grammarBuilder = new StringBuilder(338);
		grammarBuilder.append("grammar T;\n");
		...
		grammarBuilder.append("{document.getElementById('output').value += this.getExpectedTokens().toString(this.literalNames) + '\\n';}\n");
		grammarBuilder.append("  : ;");
		String grammar = grammarBuilder.toString();
	...
	public void testContextListGetters() throws Exception {
		...
		grammarBuilder.append("a : 'a' {document.getElementById('output').value += 'a';};\n");
		grammarBuilder.append("b : 'b' {document.getElementById('output').value += 'b';};");
		String grammar = grammarBuilder.toString();
		String input ="abab";
		String found = execParser("T.g4", grammar, "TParser", "TLexer",
		                          "TListener", "TVisitor",
