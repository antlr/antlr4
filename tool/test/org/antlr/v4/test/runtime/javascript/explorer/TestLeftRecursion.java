...
public class TestLeftRecursion extends BaseTest {
	...
	public void testTernaryExprExplicitAssociativity_5() throws Exception {
		...
		grammarBuilder.append("s @after {document.getElementById('output').value += $ctx.toStringTree(null, this) + '\\n';} : e EOF; // must indicate EOF can follow or 'a<EOF>' won't match\n");
	...
	public void testReturnValueAndActionsAndLabels_2() throws Exception {
		...
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("s : q=e {document.getElementById('output').value += $e.v + '\\n';}; \n");
	...
	public void testJavaExpressions_9() throws Exception {
		mkdir(tmpdir);
		StringBuilder grammarBuilder = new StringBuilder(1291);
		grammarBuilder.append("grammar T;\n");
	...
	public void testReturnValueAndActions_1() throws Exception {
		...
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("s : e {document.getElementById('output').value += $e.v + '\\n';}; \n");
	...
	public void testDeclarations_10() throws Exception {
		mkdir(tmpdir);
		StringBuilder grammarBuilder = new StringBuilder(435);
		grammarBuilder.append("grammar T;\n");
	...
	public void testPrefixOpWithActionAndLabel_3() throws Exception {
		mkdir(tmpdir);
		StringBuilder grammarBuilder = new StringBuilder(373);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("s : e {document.getElementById('output').value += $e.result + '\\n';} ;\n");
	...
	public void testReturnValueAndActionsList2_1() throws Exception {
		mkdir(tmpdir);
		StringBuilder grammarBuilder = new StringBuilder(361);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("s @after {document.getElementById('output').value += $ctx.toStringTree(null, this) + '\\n';} : expr EOF;\n");
		grammarBuilder.append("expr:\n");
		grammarBuilder.append("    a=expr '*' a=expr #Factor\n");
	...
	public void testDirectCallToLeftRecursiveRule_1() throws Exception {
		...
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("a @after {document.getElementById('output').value += $ctx.toStringTree(null, this) + '\\n';} : a ID\n");
		grammarBuilder.append("  | ID\n");
		grammarBuilder.append("  ;\n");
		grammarBuilder.append("ID : 'a'..'z'+ ;\n");
		grammarBuilder.append("WS : (' '|'\\n') -> skip ;");
