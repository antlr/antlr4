...
public class TestLexerExec extends BaseTest {
	...
	public void testCharSet() throws Exception {
		...
		grammarBuilder.append("I : '0'..'9'+ {document.getElementById('output').value += \"I\" + '\\n';} ;\n");
	...
	public void testGreedyConfigs() throws Exception {
		...
		grammarBuilder.append("lexer grammar L;\n");
		grammarBuilder.append("I : ('a' | 'ab') {document.getElementById('output').value += this.text + '\\n';} ;\n");
		grammarBuilder.append("WS : (' '|'\\n') -> skip ;\n");
	...
	public void testCharSetWithMissingEndRange() throws Exception {
		...
		grammarBuilder.append("lexer grammar L;\n");
		grammarBuilder.append("I : [0-]+ {document.getElementById('output').value += \"I\" + '\\n';} ;\n");
		grammarBuilder.append("WS : [ \\n\\u000D]+ -> skip ;");
		String grammar = grammarBuilder.toString();
		String input ="00\n";
		String found = execLexer("L.g4", grammar, "L", input, false);
	...
	public void testCharSetWithEscapedChar() throws Exception {
		...
		grammarBuilder.append("lexer grammar L;\n");
		grammarBuilder.append("DASHBRACK : [\\-\\]]+ {document.getElementById('output').value += \"DASHBRACK\" + '\\n';} ;\n");
		grammarBuilder.append("WS : [ \\u]+ -> skip ;");
		String grammar = grammarBuilder.toString();
		String input ="- ] ";
		String found = execLexer("L.g4", grammar, "L", input, false);
	...
	public void testActionPlacement() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(448);
		grammarBuilder.append("lexer grammar L;\n");
		grammarBuilder.append("I : ({document.getElementById('output').value += \"stuff fail: \" + this.text + '\\n';} 'a'\n");
		grammarBuilder.append("| {document.getElementById('output').value += \"stuff0: \" + this.text + '\\n';}\n");
		grammarBuilder.append("		'a' {document.getElementById('output').value += \"stuff1: \" + this.text + '\\n';}\n");
		grammarBuilder.append("		'b' {document.getElementById('output').value += \"stuff2: \" + this.text + '\\n';})\n");
		grammarBuilder.append("		{document.getElementById('output').value += this.text + '\\n';} ;\n");
		grammarBuilder.append("WS : (' '|'\\n') -> skip ;\n");
		grammarBuilder.append("J : .;");
		String grammar = grammarBuilder.toString();
		String input ="ab";
	...
	public void testPositionAdjustingLexer() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(2231);
	...
	public void testCharSetWithQuote1() throws Exception {
		...
		grammarBuilder.append("lexer grammar L;\n");
		grammarBuilder.append("A : [\"a-z]+ {document.getElementById('output').value += \"A\" + '\\n';} ;\n");
		grammarBuilder.append("WS : [ \\n\\t]+ -> skip ;");
		String grammar = grammarBuilder.toString();
		String input ="b\"a";
		String found = execLexer("L.g4", grammar, "L", input, false);
	...
	public void testNonGreedyConfigs() throws Exception {
		...
		grammarBuilder.append("I : .*? ('a' | 'ab') {document.getElementById('output').value += this.text + '\\n';} ;\n");
		grammarBuilder.append("WS : (' '|'\\n') -> skip ;\n");
		grammarBuilder.append("J : . {document.getElementById('output').value += this.text + '\\n';};");
		String grammar = grammarBuilder.toString();
		String input ="ab";
		String found = execLexer("L.g4", grammar, "L", input, false);
		assertEquals(
	...
	public void testCharSetWithQuote2() throws Exception {
		...
		grammarBuilder.append("lexer grammar L;\n");
		grammarBuilder.append("A : [\"\\\\ab]+ {document.getElementById('output').value += \"A\" + '\\n';} ;\n");
		grammarBuilder.append("WS : [ \\n\\t]+ -> skip ;");
		String grammar = grammarBuilder.toString();
		String input ="b\"\\a";
		String found = execLexer("L.g4", grammar, "L", input, false);
	...
	public void testCharSetWithReversedRange() throws Exception {
		...
		grammarBuilder.append("lexer grammar L;\n");
		grammarBuilder.append("A : [z-a9]+ {document.getElementById('output').value += \"A\" + '\\n';} ;\n");
		grammarBuilder.append("WS : [ \\u]+ -> skip ;");
		String grammar = grammarBuilder.toString();
		String input ="9";
		String found = execLexer("L.g4", grammar, "L", input, false);
	...
	public void testCharSetRange() throws Exception {
		...
		grammarBuilder.append("lexer grammar L;\n");
		grammarBuilder.append("I : [0-9]+ {document.getElementById('output').value += \"I\" + '\\n';} ;\n");
		grammarBuilder.append("ID : [a-zA-Z] [a-zA-Z0-9]* {document.getElementById('output').value += \"ID\" + '\\n';} ;\n");
		grammarBuilder.append("WS : [ \\n\\u0009\\r]+ -> skip ;");
		String grammar = grammarBuilder.toString();
		String input =
			"34\n" +
