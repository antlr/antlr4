...
public class TestLeftRecursion extends BaseTest {
	...
	public void testTernaryExprExplicitAssociativity_5() throws Exception {
		...
		grammarBuilder.append("s @after {System.out.println($ctx.toStringTree(this));} : e EOF; // must indicate EOF can follow or 'a<EOF>' won't match\n");
	...
	public void testReturnValueAndActionsAndLabels_2() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(461);
		grammarBuilder.append("grammar T;\n");
	...
	public void testWhitespaceInfluence_2() throws Exception {
		...
		String found = execParser("Expr.g4", grammar, "ExprParser", "ExprLexer", "prog", input, false);
		assertEquals("", found);
		assertNull(this.stderrDuringParse);
	...
	public void testJavaExpressions_9() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(1255);
		grammarBuilder.append("grammar T;\n");
	...
	public void testAmbigLR_5() throws Exception {
		...
		String input ="(1+2)*3\n";
		String found = execParser("Expr.g4", grammar, "ExprParser", "ExprLexer", "prog", input, true);
		assertEquals("", found);
		assertNull(this.stderrDuringParse);
	...
	public void testDeclarations_10() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(399);
		grammarBuilder.append("grammar T;\n");
	...
	public void testReturnValueAndActionsList2_1() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(325);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("s @after {System.out.println($ctx.toStringTree(this));} : expr EOF;\n");
		grammarBuilder.append("expr:\n");
		grammarBuilder.append("    a=expr '*' a=expr #Factor\n");
