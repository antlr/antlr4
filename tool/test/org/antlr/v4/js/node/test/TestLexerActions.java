...
public class TestLexerActions extends BaseTest {
	...
	@Test public void testActionEvalsAtCorrectIndex() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
			"I : [0-9] {console.log(\"2nd char: \" + String.fromCharCode(this._input.LA(1)));} [0-9]+ ;\n"+
			"WS : (' '|'\\n') -> skip ;";
	...
	@Test public void testEvalMultipleActions() throws Exception {
		String grammar =
			...
			"}\n" +
			"\n" +
			"HELLO: 'hello' WS {this.start();} NAME {this.stop();} '\\n' {console.log(\"Hello: \" + this.getRecordedText ());};\n" +
			"NAME: ('a'..'z' | 'A'..'Z')+ ('\\n')?;\n" +
			"\n" +
			"fragment WS: [ \\r\\t\\n]+ ;\n";
	...
	public void testFailingPredicateEvalIsNotCached() {
		String grammar =
			...
			"fragment EOL: '\\r'? '\\n';\n" +
			"\n" +
			"LINE: WS? ~[\\r\\n]* EOL {this.text.trim().lastIndexOf(\"Item:\", 0)!==0}?;\n" +
