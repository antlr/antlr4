...
public class TestFullContextParsing extends BaseTest {
	...
	public void testAmbigYieldsCtxSensitiveDFA() throws Exception {
		String grammar = "grammar T;\n" +
	                  ...
	                  "ID : 'a'..'z'+;\n" +
	                  "WS : (' '|'\\t'|'\\n')+ -> skip ;";
		String found = execParser("T.g4", grammar, "TParser", "TLexer", "TListener", "TVisitor", "s", "abc");
	...
	public void testCtxSensitiveDFA_1() throws Exception {
		String grammar = "grammar T;\n" +
	                  ...
	                  "INT : '0'..'9'+ ;\n" +
	                  "WS : (' '|'\\t'|'\\n')+ -> skip ;";
		String found = execParser("T.g4", grammar, "TParser", "TLexer", "TListener", "TVisitor", "s", "$ 34 abc");
	...
	public void testCtxSensitiveDFATwoDiffInput() throws Exception {
		String grammar = "grammar T;\n" +
	                  ...
	                  "INT : '0'..'9'+ ;\n" +
	                  "WS : (' '|'\\t'|'\\n')+ -> skip ;";
		String found = execParser("T.g4", grammar, "TParser", "TLexer", "TListener", "TVisitor", "s", "$ 34 abc @ 34 abc");
	...
	public void testFullContextIF_THEN_ELSEParse_1() throws Exception {
		String grammar = "grammar T;\n" +
	                  ...
	                  "ID : 'a'..'z'+ ;\n" +
	                  "WS : (' '|'\\t'|'\\n')+ -> skip ;";
		String found = execParser("T.g4", grammar, "TParser", "TLexer", "TListener", "TVisitor", "s", "{ if x then return }");
		assertEquals("Decision 1:\ns0-'}'->:s1=>2\n", found);
	...
	public void testFullContextIF_THEN_ELSEParse_2() throws Exception {
		String grammar = "grammar T;\n" +
	                  ...
	                  "ID : 'a'..'z'+ ;\n" +
	                  "WS : (' '|'\\t'|'\\n')+ -> skip ;";
		String found = execParser("T.g4", grammar, "TParser", "TLexer", "TListener", "TVisitor", "s", "{ if x then return else foo }");
		assertEquals("Decision 1:\ns0-'else'->:s1^=>1\n", found);
	...
	public void testFullContextIF_THEN_ELSEParse_3() throws Exception {
		String grammar = "grammar T;\n" +
	                  ...
	                  "ID : 'a'..'z'+ ;\n" +
	                  "WS : (' '|'\\t'|'\\n')+ -> skip ;";
		String found = execParser("T.g4", grammar, "TParser", "TLexer", "TListener", "TVisitor", "s", "{ if x then if y then return else foo }");
		assertEquals("Decision 1:\ns0-'else'->:s1^=>1\ns0-'}'->:s2=>2\n", found);
	...
	public void testFullContextIF_THEN_ELSEParse_4() throws Exception {
		String grammar = "grammar T;\n" +
	                  ...
	                  "ID : 'a'..'z'+ ;\n" +
	                  "WS : (' '|'\\t'|'\\n')+ -> skip ;";
		String found = execParser("T.g4", grammar, "TParser", "TLexer", "TListener", "TVisitor", "s", "{ if x then if y then return else foo else bar }");
		assertEquals("Decision 1:\ns0-'else'->:s1^=>1\n", found);
	...
	public void testLoopsSimulateTailRecursion() throws Exception {
		String grammar = "grammar T;\n" +
	                  ...
	                  "	;\n" +
	                  "ID  : [a-z]+ ;";
		String found = execParser("T.g4", grammar, "TParser", "TLexer", "TListener", "TVisitor", "prog", "a(i)<-x");
	...
	public void testAmbiguityNoLoop() throws Exception {
		String grammar = "grammar T;\n" +
	                  ...
	                  "ID  : [a-z]+ ;\n" +
	                  "WS  : [ \\r\\n\\t]+ -> skip ;";
		String found = execParser("T.g4", grammar, "TParser", "TLexer", "TListener", "TVisitor", "prog", "a@");
		assertEquals("alt 1\n", found);
	...
	public void testExprAmbiguity_2() throws Exception {
		String grammar = "grammar T;\n" +
	                  ...
	                  "ID  : [a-zA-Z]+ ;\n" +
	                  "WS  : [ \\r\\n\\t]+ -> skip ;";
		String found = execParser("T.g4", grammar, "TParser", "TLexer", "TListener", "TVisitor", "s", "a+b*c");
