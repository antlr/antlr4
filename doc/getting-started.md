...
Or just download in browser from website:
    [www.antlr.org/download.html](https://www.antlr.org/download.html)
...
0. Install Java (version 1.7 or higher)
1. Download antlr-4.10.1-complete.jar (or whatever version) from [www.antlr.org/download.html](https://www.antlr.org/download.html)
