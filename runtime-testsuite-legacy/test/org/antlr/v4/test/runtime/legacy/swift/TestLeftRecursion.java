...
public class TestLeftRecursion extends BaseTest {
	...
	public void testDeclarations_1() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(385);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("s @after {print($ctx.toStringTree(self))} : declarator EOF ; // must indicate EOF can follow\n");
	...
	public void testDirectCallToLeftRecursiveRule_1() throws Exception {
		...
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("a @after {print($ctx.toStringTree(self))} : a ID\n");
		grammarBuilder.append("  | ID\n");
		grammarBuilder.append("  ;\n");
		grammarBuilder.append("ID : 'a'..'z'+ ;\n");
		grammarBuilder.append("WS : (' '|'\\n') -> skip ;");
	...
	public void testExpressions_1() throws Exception {
		...
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("s @after {print($ctx.toStringTree(self))} : e EOF ; // must indicate EOF can follow\n");
	...
	public void testJavaExpressions_1() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(1241);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("s @after {print($ctx.toStringTree(self))} : e EOF ; // must indicate EOF can follow\n");
	...
	public void testLabelsOnOpSubrule_1() throws Exception {
		...
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("s @after {print($ctx.toStringTree(self))} : e;\n");
	...
	public void testPrefixAndOtherAlt_1() throws Exception {
		...
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("s @after {print($ctx.toStringTree(self))} : expr EOF ; \n");
	...
	public void testReturnValueAndActions_1() throws Exception {
		...
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("s : e {print($e.v)}; \n");
		grammarBuilder.append("e returns [int v, Array<String> ignored]\n");
	...
	public void testSemPred() throws Exception {
		...
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("s @after {print($ctx.toStringTree(self))} : a ;\n");
	...
	public void testTernaryExprExplicitAssociativity_1() throws Exception {
		...
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("s @after {print($ctx.toStringTree(self))} : e EOF; // must indicate EOF can follow or 'a<EOF>' won't match\n");
