...
public class TestLexerExec extends BaseCSharpTest {
	...
	public void testNonGreedyConfigs() throws Exception {
		...
		grammarBuilder.append("I : .*? ('a' | 'ab') {Console.WriteLine(this.Text);} ;\n");
		grammarBuilder.append("WS : (' '|'\\n') -> skip ;\n");
		grammarBuilder.append("J : . {Console.WriteLine(this.Text);};");
		String grammar = grammarBuilder.toString();
	...
	public void testPositionAdjustingLexer() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(2208);
