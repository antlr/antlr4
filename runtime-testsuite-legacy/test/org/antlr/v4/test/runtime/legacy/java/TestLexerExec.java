...
public class TestLexerExec extends LegacyBaseJavaTest {
	...
	public void testNonGreedyConfigs() throws Exception {
		...
		grammarBuilder.append("I : .*? ('a' | 'ab') {System.out.println(this.getText());} ;\n");
		grammarBuilder.append("WS : (' '|'\\n') -> skip ;\n");
		grammarBuilder.append("J : . {System.out.println(this.getText());};");
		String grammar = grammarBuilder.toString();
	...
	public void testPositionAdjustingLexer() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(2501);
