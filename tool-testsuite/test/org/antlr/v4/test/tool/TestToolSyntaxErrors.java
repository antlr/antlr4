...
public class TestToolSyntaxErrors {
	final static String[] A = {
		...
		"A;",
		"error(" + ErrorType.SYNTAX_ERROR.code + "): null.g4:1:0: syntax error: 'A' came as a complete surprise to me\n",

		"grammar ;",
		"error(" + ErrorType.SYNTAX_ERROR.code + "): null.g4:1:8: syntax error: ';' came as a complete surprise to me while looking for an identifier\n",

		"grammar A\n" +
		"a : ID ;\n",
		"error(" + ErrorType.SYNTAX_ERROR.code + "): null.g4:2:0: syntax error: missing SEMI at 'a'\n",
