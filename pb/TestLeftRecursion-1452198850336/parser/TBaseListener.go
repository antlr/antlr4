...
func (s *BaseTListener) EnterS(ctx *SContext) {}

func (s *BaseTListener) ExitS(ctx *SContext){}

func (s *BaseTListener) EnterE(ctx *EContext) {}

func (s *BaseTListener) ExitE(ctx *EContext){}
