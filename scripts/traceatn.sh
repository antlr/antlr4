...
export ANTLRJAR=~/.m2/repository/org/antlr/antlr4/4.12.0-SNAPSHOT/antlr4-4.12.0-SNAPSHOT-complete.jar
export TESTJAR=~/.m2/repository/org/antlr/antlr4-runtime-testsuite/4.12.0-SNAPSHOT/antlr4-runtime-testsuite-4.12.0-SNAPSHOT-tests.jar
