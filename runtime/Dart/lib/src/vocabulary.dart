...
abstract class Vocabulary {
  ...
  ///
  /// <ol>
  ///  <li>The result of [getLiteralName]</li>
  ///  <li>The result of [getSymbolicName]</li>
  ///  <li>The result of [int.toString]</li>
  /// </ol>
  ///
  /// @param tokenType The token type.
  ///
...
class VocabularyImpl implements Vocabulary {
  ...
  /// to use the values in [literalNames] and [symbolicNames] as the source of
  /// display names, as described in [getDisplayName].
  ///
