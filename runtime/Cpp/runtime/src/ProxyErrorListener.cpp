...
void ProxyErrorListener::removeErrorListener(ANTLRErrorListener *listener) { _delegates.erase(listener); }
...
void ProxyErrorListener::reportContextSensitivity(Parser *recognizer, const dfa::DFA &dfa, size_t startIndex,
