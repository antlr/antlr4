...
namespace antlr4::atn {
  ...
  protected:
    ...
    ///  was not required in order to produce a correct prediction for this decision and input
    ///  sequence. It may in fact still be a context sensitivity but we don't know by looking at
    ///  the minimum alternatives for the current input.
    /// </summary>
