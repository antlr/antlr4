...
// Specialized view of the serialized ATN that performs the value shift on each element as it is accessed.
...
ssize_t readUnicodeInt(SerializedATNView data, int& p) {
