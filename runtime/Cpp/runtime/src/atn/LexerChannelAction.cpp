...
LexerActionType LexerChannelAction::getActionType() const { return LexerActionType::CHANNEL; }
...
std::string LexerChannelAction::toString() const { return "channel(" + std::to_string(_channel) + ")"; }
