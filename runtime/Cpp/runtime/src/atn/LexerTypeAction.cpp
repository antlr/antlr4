...
LexerActionType LexerTypeAction::getActionType() const { return LexerActionType::TYPE; }
...
std::string LexerTypeAction::toString() const { return "type(" + std::to_string(_type) + ")"; }
