...
namespace atn {
  ...
  /// <summary>
  /// Implements the {@code less} lexer action by calling <seealso cref="Lexer#less"/>.
  ///
  ...
  public:
    ...
    /// </summary>
    static const Ref<LexerLessAction> getInstance();

    /// <summary>
    /// {@inheritDoc} </summary>
    /// <returns> This method returns <seealso cref="LexerActionType#LESS"/>. </returns>
    ...
    /// {@inheritDoc}
    ///
    /// <para>This action is implemented by calling <seealso cref="Lexer#less"/>.</para>
    /// </summary>
