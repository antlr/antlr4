...
Transition::SerializationType RangeTransition::getSerializationType() const { return RANGE; }

misc::IntervalSet RangeTransition::label() const { return misc::IntervalSet::of((int)from, (int)to); }
