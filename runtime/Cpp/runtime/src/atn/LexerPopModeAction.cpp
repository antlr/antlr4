...
LexerActionType LexerPopModeAction::getActionType() const { return LexerActionType::POP_MODE; }
...
bool LexerPopModeAction::operator==(const LexerAction &obj) const { return &obj == this; }
