...
namespace antlr4::tree {
  ...
  public:
     ...
     * with depth-first search. On each node, <seealso cref="ParseTreeWalker#enterRule"/> is
     * called before recursively walking down into child nodes, then <seealso
     * cref="ParseTreeWalker#exitRule"/> is called after the recursive call to wind up.
     * </summary>
  ...
  protected:
    /**
     * <summary>
     * Enters a grammar rule by first triggering the generic event <seealso
     * cref="ParseTreeListener#enterEveryRule"/> then by triggering the event specific to the
     * given parse tree node
     * </summary>
