...
namespace antlr4::tree {
  ...
  // ml: no template parameter here, to avoid the need for virtual template functions. Instead we
  // have our Any class.
  ...
  public:
    ...
    /// operation.
    /// </summary>
    /// <param name="node"> The <seealso cref="ParseTree"/> whose children should be visited.
    /// </param> <returns> The result of visiting the children of the node. </returns>
