...
del *nupkg
echo nuget pack ANTLR4.Runtime.noarch.nuspec 				-p vs=%1 -p version=%2 -p pre=%pre%
call nuget pack ANTLR4.Runtime.noarch.nuspec 				-p vs=%1 -p version=%2 -p pre=%pre%
echo nuget pack ANTLR4.Runtime.shared.nuspec 	-symbols 	-p vs=%1 -p version=%2 -p pre=%pre%
call nuget pack ANTLR4.Runtime.shared.nuspec 	-symbols 	-p vs=%1 -p version=%2 -p pre=%pre%
echo nuget pack ANTLR4.Runtime.static.nuspec 	-symbols 	-p vs=%1 -p version=%2 -p pre=%pre%
call nuget pack ANTLR4.Runtime.static.nuspec 	-symbols 	-p vs=%1 -p version=%2 -p pre=%pre%
