...
export class ParserATNSimulator extends ATNSimulator {
    ...
    public debug_closure: boolean
    public debug_add: boolean
    public debug_list_atn_decisions: boolean
    public dfa_debug: boolean
    public retry_debug: boolean
    ...
    public getRuleNames(index: number): string
    ...
    ): Array<PredPrediction> | null
    protected getSynValidOrSemInvalidAltThatFinishedDecisionEntryRule(
        configs: ATNConfigSet,
        outerContext: ParserRuleContext
    ): number
    protected getAltThatFinishedDecisionEntryRule(configs: ATNConfigSet): number
    protected splitAccordingToSemanticValidity(
        configs: ATNConfigSet,
        outerContext: ParserRuleContext
    ): [ATNConfigSet, ATNConfigSet]
    protected evalSemanticContext(
        predPredictions: Array<PredPrediction>,
        outerContext: ParserRuleContext,
        complete: boolean
    ): BitSet
    protected closure(
