...
export namespace Trees {
    ...
    export function getNodeText(t: Tree, ruleNames: undefined, recog: Parser): string

    export function getChildren(t: Tree): Array<Tree>
    export function getAncestors(t: Tree): Array<Tree>
    export function findAllTokenNodes(t: ParseTree, ttype: number): Array<ParseTree>
    export function findAllRuleNodes(t: ParseTree, ruleIndex: number): Array<ParseTree>
    export function findAllNodes(t: ParseTree, index: number, findTokens: boolean): Array<ParseTree>
