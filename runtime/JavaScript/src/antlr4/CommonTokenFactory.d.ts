...
export declare class CommonTokenFactory implements TokenFactory {
    ...
    create(source: SourcePair, type: number, text: string, channel: number, start: number, stop: number, line: number, column: number): CommonToken
    // If source[1] and text are null, then start and stop are optional.
    create(source: [Lexer, null], type: number, text: null, channel: number, start: number | undefined, stop: number | undefined, line: number, column: number): CommonToken
