...
// LexerActionExecutor represents an executor for a sequence of lexer actions
// which traversed during the Matching operation of a lexer rule (token).
//
...
// NewLexerActionExecutor returns a new instance of LexerActionExecutor.
func NewLexerActionExecutor(lexerActions []LexerAction) *LexerActionExecutor {
	...
	l := &LexerActionExecutor{
		lexerActions: lexerActions,
		cachedHash:   murmurInit(57),
	}
...
// LexerActionExecutorappend creates a LexerActionExecutor which executes the
// actions for the input lexerActionExecutor followed by a specified
// lexerAction.
//
