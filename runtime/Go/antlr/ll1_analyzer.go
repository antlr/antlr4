...
func (la *LL1Analyzer) look2(s, stopState ATNState, ctx PredictionContext, look *IntervalSet, lookBusy *_set, calledRuleStack *bitSet, seeThruPreds, addEOF bool, i int) {
...
func (la *LL1Analyzer) look1(s, stopState ATNState, ctx PredictionContext, look *IntervalSet, lookBusy *_set, calledRuleStack *bitSet, seeThruPreds, addEOF bool) {
...
func (la *LL1Analyzer) look3(stopState ATNState, ctx PredictionContext, look *IntervalSet, lookBusy *_set, calledRuleStack *bitSet, seeThruPreds, addEOF bool, t1 *RuleTransition) {
