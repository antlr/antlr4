// $ANTLR 3.2.1-SNAPSHOT Jan 26, 2010 15:12:28 Semantics.g 2010-01-27 16:25:17
...
public class Semantics extends TreeFilter {
    ...
    public final void gUnitDef() throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,27,FOLLOW_27_in_gUnitDef67); if (state.failed) return ;
        ...
        try {
            ...
            switch (alt4) {
                case 1 :
                    ...
                    {
                    match(input,30,FOLLOW_30_in_option109); if (state.failed) return ;
                ...
                case 2 :
                    ...
                    {
                    match(input,30,FOLLOW_30_in_option132); if (state.failed) return ;
    ...
    public static final BitSet FOLLOW_27_in_gUnitDef67 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_ID_in_gUnitDef69 = new BitSet(new long[]{0x0000003FFFFFFFF8L});
    public static final BitSet FOLLOW_OPTIONS_in_optionsSpec88 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_option_in_optionsSpec90 = new BitSet(new long[]{0x0000000040000008L});
    public static final BitSet FOLLOW_30_in_option109 = new BitSet(new long[]{0x0000000000000004L});
    ...
    public static final BitSet FOLLOW_30_in_option132 = new BitSet(new long[]{0x0000000000000004L});
